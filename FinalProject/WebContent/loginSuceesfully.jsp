...
<div id="wrapper">
    <section id="main">
        ...
        <form action="reservationInformation" method="GET">
               <%-- <div class="field">
                    <a href="/test87/reservationInformation" id="reservation">Reservation</a>
               </div> --%>
        	<button class="actions special" type="submit">Reservation</button>
        </form>
        <form action="CheckResult" method="GET">
                	<button class="actions special" type="submit">Check</button>
        
                <%--div class="field">
                     <a href="/test87/check" id="check">Check</a>
                </div --%>
        </form>
        <hr />
    </section>
