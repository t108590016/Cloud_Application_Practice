...
<div id="wrapper">
    <section id="main">
        ...
        <hr />
         <p>Reservation</p>
        <form action="reservationInformation" method="POST">
            <div class="fields">
                <div class="field">
                    <input type="text" name="userID" id="userID" placeholder="userID" required/>
                </div>
                <div class="field">
                    <input type="password" name="passwd" id="passwd" placeholder="passwd" required/>
                </div>
                <div class="field">
            ...
            <button class="actions special" type="submit">預約</button>
        </form>
        <hr />
    </section>
</div>
